    ...
    <div class="step-container" id="step3">
        ...
        <div class="detailed-content">
            ...
            <div class="cancellation-policy">
                ...
                <div class="policy-content">
                    <p><strong>Fontos!</strong></p>
                    <p>Ha elalszol a kezelés alatt, az teljesen rendben van – ez azt jelenti, hogy a tested végre ellazult és megbízik benned.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="detailed-content">
            <div class="three-columns">
                ...
                <div class="column">
                    ...
                    <ul>
                        <li>Sok folyadék fogyasztása (víz, gyógytea)</li>
                        <li>Pihenés és regeneráció</li>
                        <li>Testmozgás, ha jólesik</li>
                        <li>Sófürdő stb</li>
                    </ul>
                </div>
                ...
                <div class="column">
                    <div class="column-icon">🔄</div>
                    <p>Milyen gyakran érdemes jönni következő kezelésre?</p>
                    <ul>
                        <li>Ez attól függ, mi a célod és hogy mennyit szeretnél javítani vagy fenntartani</li>
            ...
            <div class="cancellation-policy">
                ...
                <div class="policy-content">
                    ...
                    <p>Ne aggódj, bármilyen kérdés felmerülhet! Hívj bármikor: +36 30 280 1463 vagy írj emailt és szívesen segítek!</p>
                </div>
            </div>
        </div>
    </div>
